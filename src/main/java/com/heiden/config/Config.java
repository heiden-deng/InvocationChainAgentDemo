...
package com.heiden.config;


import com.heiden.logging.core.LogLevel;
import com.heiden.logging.core.LogOutput;
import com.heiden.logging.core.ResolverType;
import com.heiden.logging.core.WriterFactory;
import com.heiden.utils.Length;
...
public class Config {
    ...
    public static class Agent {
        ...
        /**
         * Negative or zero means off, by default. {@code #SAMPLE_N_PER_3_SECS} means sampling N  in
         * 3 seconds tops.
         */
    ...
    public static class Logging {
         ...
         * Log file name.
         */
        public static String FILE_NAME = "cebtrace-api.log";
         ...
         *
         * @see com.heiden.logging.core.PatternLogger#DEFAULT_CONVERTER_MAP
         */
    ...
    public static Set<String>  RequestModeSet = new HashSet<String>(){{
        add("GetMapping");
        add("PostMapping");
        add("RequestMapping");
    }};
    public static String AppPkgKey = "AppPkgName";
    public static String AppPkgName = "com.eb.pretest";

    public static String KafkaServerKey = "KafkaIP";

    public static String KafkaTopicKey = "KafkaTopic";
    public static String KafkaTopicName = "call_graph";
    public static String KafkaTopicKeyKey = "KafkaKey";
    public static String KafkaTopicKeyName = "test";


    public static String ClassFileSaveDirKey = "SaveDir";

    public static String ClassFileSaveDir = "";
